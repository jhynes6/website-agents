...
Chunking controls how documents are split into smaller units before indexing. Each chunking strategy is optimized for different document types and retrieval patterns, allowing you to tailor knowledge base performance to your specific dataset. Chunking settings are configured per data source, and you can mix strategies within the same knowledge base.

Gradient AI Platform supports several chunking strategies (including section-based, semantic, hierarchical, and fixed-length) to improve retrieval accuracy for structured, unstructured, or mixed-format documents. Some strategies prioritize speed and cost efficiency, while others provide deeper semantic understanding or expanded context windows.

For a full description of each strategy, configuration parameters, and recommended use cases, see [Chunking Strategy Best Practices](https://docs.digitalocean.com/products/gradient-ai-platform/concepts/chunking-strategies/) and [chunking reference page](https://docs.digitalocean.com/products/gradient-ai-platform/reference/chunking-strategies/).
...
The Gradient AI Agent Development Kit (ADK) is an SDK to build, test, and deploy agent workflows from within your development environments. Using the SDK, you can:

- Build agents with existing models that DigitalOcean provides, including commercial models from OpenAI and Anthropic, or third-party models. You can use any model key, even if the model isn’t hosted on DigitalOcean or the model key is not provided by DigitalOcean.

- Have multiple versions of your agent deployed to different environments in the same workspace simultaneously. This lets you test agent configurations and workflows exhaustively before you deploy the workflow to production.

- Capture calls to LangGraph nodes automatically to create traces to debug and evaluate agent performance when you use LangGraph to add nodes.


See [Build Agents Using the Agent Development Kit](https://docs.digitalocean.com/products/gradient-ai-platform/how-to/build-agents-using-adk/) to learn more about using the ADK to create agents.
...
- [RAG Pipelines and Knowledge Bases](https://docs.digitalocean.com/products/gradient-ai-platform/details/features/#rag-pipelines-and-knowledge-bases)
  - [Embedding Models](https://docs.digitalocean.com/products/gradient-ai-platform/details/features/#embedding-models)
  - [Activity Logs](https://docs.digitalocean.com/products/gradient-ai-platform/details/features/#activity-logs)
  - [Auto-Indexing](https://docs.digitalocean.com/products/gradient-ai-platform/details/features/#auto-indexing)
  - [Chunking](https://docs.digitalocean.com/products/gradient-ai-platform/details/features/#chunking)
...
- [Agent Development Kit](https://docs.digitalocean.com/products/gradient-ai-platform/details/features/#agent-development-kit)
